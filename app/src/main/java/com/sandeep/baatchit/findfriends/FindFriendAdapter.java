...
public class FindFriendAdapter extends RecyclerView.Adapter<FindFriendAdapter.FindFriendViewHolder> {
    ...
    public FindFriendAdapter.FindFriendViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //converts Xml file to programable view
    ...
    public void onBindViewHolder(@NonNull FindFriendAdapter.FindFriendViewHolder holder, int position) {
       final FindFriendModel friendModel = findFriendModelList.get(position);
        ...
        friendRequestDatabase = FirebaseDatabase.getInstance().getReference().child(NodeName.FRIEND_REQUESTS);
        ...
        holder.btnSendRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                friendRequestDatabase.child(currentUser.getUid()).child(userId).child(NodeName.REQUEST_TYPE)
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            friendRequestDatabase.child(userId).child(currentUser.getUid()).child(NodeName.REQUEST_TYPE)
